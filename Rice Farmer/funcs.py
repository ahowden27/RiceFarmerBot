...
async def save_and_scan_image(interaction, file):
    dirpath = os.path.join(r'C:\Users\Alex\Documents\Programming\Rice Farmer', interaction.user.name)
...
async def save_and_scan_pdf(interaction, file):
    pdfdirpath = os.path.join(r'C:\Users\Alex\Documents\Programming\Rice Farmer', interaction.user.name + 'pdf')
    dirpath = os.path.join(r'C:\Users\Alex\Documents\Programming\Rice Farmer', interaction.user.name)
    ...
    await file.save(filepath)
    images = convert_from_path(filepath, dirpath)
